...
# NewData
# It had budget of  $ 30 million and was shown in 3,065 theatres, grossing  $ 19.83 million during 
# the first weekend. The movie's IMDb rating was 7.6 out of 10. Obtain a 
# 99% prediction interval for the USRevenue based on the model with all four predictors.
movies_model <- lm(USRevenue~Budget+Theatres+Opening+Ratings, data=Movies)
